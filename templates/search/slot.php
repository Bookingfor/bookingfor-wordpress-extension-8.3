...
<?php if ($total > 0){ ?>
	<?php 
			...
			bfi_get_template("search/default_results_slot.php",array("results"=>$results,"totalAvailable"=>$totalAvailable,"total"=>$total,"items"=>$items,"pages"=>$pages,"page"=>$page,"currencyclass"=>$currencyclass,"listNameAnalytics"=>$listNameAnalytics,"totPerson"=>$totPerson,"currSorting"=>$currSorting));	
