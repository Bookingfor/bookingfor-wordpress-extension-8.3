...
?>
						...
						<div class="bfi-item-address">
							...
							<a href="javascript:void(0);" onclick="event.stopPropagation();showMarker(<?php echo $merchant->MerchantId?>)"><span id="address<?php echo $merchant->MerchantId?>"></span></a>
...
?>
				...
				<div class="bfi-row" >
					<div class="bfi-col-sm-6">
						...
						<?php endif; ?>
						<a href="<?php echo $resourceRoute?>" onclick="event.stopPropagation();"  class="bfi-subitem-title eectrack" <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?> data-type="Resource" data-id="<?php echo $merchant->ResourceId?>" data-index="<?php echo $counter?>" data-itemname="<?php echo $resourceNameTrack; ?>" data-category="<?php echo $merchantCategoryNameTrack; ?>" data-brand="<?php echo $merchantNameTrack; ?>"><?php echo $resourceName; ?></a>
					</div>
					...
					<div class="bfi-col-sm-3 bfi-text-right">
						<?php if (!$merchant->IsCatalog && $onlystay ){ 
							...
							<a href="<?php echo $resourceRoute ?>" onclick="event.stopPropagation();"  class="bfi-btn eectrack <?php echo $btnClass ?>" <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?> data-type="Resource" data-id="<?php echo $merchant->ResourceId?>" data-index="<?php echo $counter?>" data-itemname="<?php echo $resourceNameTrack; ?>" data-category="<?php echo $merchantCategoryNameTrack; ?>" data-brand="<?php echo $merchantNameTrack; ?>"><?php echo _e('Request' , 'bfi')?></a>
						<?php } ?>
					</div>
				</div>
				<div class="bfi-clearfix bfi-hr-separ"></div>
...
//										}
					...
					<div class="bfi-col-sm-3 bfi-text-right">
						<?php if ($merchant->Price > 0){ ?>
								<a href="<?php echo $resourceRoute ?>" onclick="event.stopPropagation();"  class="bfi-btn eectrack <?php echo $btnClass ?> data-type="Resource" data-id="<?php echo $merchant->ResourceId?>" data-index="<?php echo $counter?>" data-itemname="<?php echo $resourceNameTrack; ?>" data-category="<?php echo $merchantCategoryNameTrack; ?>" data-brand="<?php echo $merchantNameTrack; ?>"" <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?>><?php echo $btnText ?></a>
						<?php }else{ ?>
								<a href="<?php echo $resourceRoute ?>" onclick="event.stopPropagation();"  class="bfi-btn eectrack <?php echo $btnClass ?> data-type="Resource" data-id="<?php echo $merchant->ResourceId?>" data-index="<?php echo $counter?>" data-itemname="<?php echo $resourceNameTrack; ?>" data-category="<?php echo $merchantCategoryNameTrack; ?>" data-brand="<?php echo $merchantNameTrack; ?>"" <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?>><?php echo _e('Request' , 'bfi')?></a>
						<?php } ?>
					</div>
				</div>
				<div class="bfi-clearfix"></div>
...
function getDiscountsAjaxInformations(discountIds,obj, fn){
	...
	jQuery.get(bookingfor.getActionUrl(null, null, "getDiscountDetails", "discountId=" + discountIds + "&language=<?php echo $language ?>"), function(data) {
			$html = '';
			jQuery.each(data || [], function(key, val) {
				var name = val.Name;
