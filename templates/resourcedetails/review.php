...
<div class="bfi-alert bfi-alert-danger" id="msgKo">
	<center><h4><?php _e('Attention!', 'bfi') ?></h4> <?php _e('It \'s not possible to insert your own review', 'bfi') ?></center>
	<div class="errorRatingReason">
<?php 
	switch ( $ratingError) {
		case '1' :
			 _e('nonexistent order', 'bfi');
		break;
		case '2' :
			 _e('Order with already a Review', 'bfi');
		break;
		case '3' :
			 _e('nonexistent order or to which it is not possible to associate a review', 'bfi');
		break;
		case '4' :
			 _e('Order not related at this resource', 'bfi');
		break;
		case '4' :
			 _e('Order make before the date to make a review', 'bfi');
		break;
	}
?>	
	</div>
