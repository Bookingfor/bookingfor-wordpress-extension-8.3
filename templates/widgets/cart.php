...
?>
<a href="<?php echo $url_cart_page ?>" class="bfi-shopping-cart bfi-shopping-cart-widget"><i class="fa fa-shopping-cart "></i> <span class="bfibadge" style="<?php echo (COM_BOOKINGFORCONNECTOR_SHOWBADGE) ?"":"display:none"; ?>"><?php echo ($currentCartsItems>0) ?$currentCartsItems:"";?></span><span class="bfi-shopping-cart-label"><?php _e('Cart', 'bfi') ?></span></a>
