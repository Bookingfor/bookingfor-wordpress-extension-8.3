	...
	<div class="bfi-form-field">
		...
		<div class="bfi-row">
			<div class="bfi-col-md-12">
				...
				<textarea name="pregi" class="" style="height:200px;" data-rule-nourl="true"  data-msg-nourl="<?php _e('No URLs allowed!', 'bfi') ?>" ></textarea>    
			</div>
		</div>
		<div class="bfi-row">
			<div class="bfi-col-md-12">
				<label><?php _e("List of the facility's negative points", 'bfi'); ?> </label>
				<textarea name="difetti" class="" style="height:200px;" data-rule-nourl="true"  data-msg-nourl="<?php _e('No URLs allowed!', 'bfi') ?>" ></textarea>    
			</div>
		</div>
		<div class="bfi-row">
				<div class="bfi-col-md-12 bfi-checkbox-wrapper">
					...
					<label for="optinprivacy"><?php echo sprintf(__('I consent to the publication of the review', 'bfi'),$sitename) ?> - <a href="<?php echo $routePrivacy ?>" target="_blank"><?php _e('More information', 'bfi') ?></a></label>
				</div>
            <?php if(BFCHelper::GetSettingValue($portalinfo->Settings,'system.gdpr.newsletter.enable')) { ?>            
				<div class="bfi-col-md-12 bfi-checkbox-wrapper">
            ...
            <?php } ?>
            <?php if(BFCHelper::GetSettingValue($portalinfo->Settings,'system.gdpr.marketing.enable')) { ?>            
				<div class="bfi-col-md-12 bfi-checkbox-wrapper">
            ...
            <?php } ?>
            <?php if(BFCHelper::GetSettingValue($portalinfo->Settings,'system.gdpr.dataprofiling.enable')) { ?>            
				<div class="bfi-col-md-12 bfi-checkbox-wrapper">
		...
		<span style="display:none;"><input type="text" name="Fax" value="" /></span>
