	...
	?>
		...
		<div class="bfi-clearfix "></div>
			...
			<div id="divcalculator">
				...
				$resourcegroupId = 0;
				$refreshSearch = 0;
				bfi_get_template("shared/search_details.php",array("merchant"=>$merchant,"resourceId"=>$resourceId,"resourcegroupId"=>$resourcegroupId,"currvariationPlanId"=>$currvariationPlanId,"currencyclass"=>$currencyclass,"refreshSearch"=>$refreshSearch));	
