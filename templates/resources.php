	...
	<div class="bfi-col-sm-6 bfi-item">
		<div class="bfi-row bfi-sameheight" >
			<div class="bfi-col-sm-3 bfi-img-container">
				<a href="<?php echo $resourceRoute ?>" onclick="event.stopPropagation();"  style='background: url("<?php echo $resourceImageUrl; ?>") center 25% / cover;' <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?>><img src="<?php echo $resourceImageUrl; ?>" class="bfi-img-responsive" /></a> 
			</div>
				...
				<div class="bfi-row" >
					<div class="bfi-col-sm-12">
						<div class="bfi-item-title">
							<a href="<?php echo $resourceRoute ?>" onclick="event.stopPropagation();"  id="nameAnchor<?php echo $resource->ResourceId?>" <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?>><?php echo  $resource->Name ?></a> 
...
?>
							...
							<?php if($isportal){ ?>
							- <a href="<?php echo $routeMerchant?>" onclick="event.stopPropagation();"  class="bfi-subitem-title" <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?>><?php echo $resource->MerchantName; ?></a>
							<?php } ?>
							<span class="bfi-item-rating">
							</span>
						</div>
						<div class="bfi-item-address">
							...
							<div class="bfi-hide" id="markerInfo<?php echo $resource->ResourceId?>">
									<div class="bfi-item-title">
										<a href="<?php echo $resourceRoute ?>" onclick="event.stopPropagation();"  <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?> ><?php echo  $resource->Name  ?></a> 
										<span class="bfi-item-rating">
<?php 
				$ratingModel = array(
					"ratingModel"=>$resource
...
?>
						...
						<div class="bfi-description bfi-shortentext" id="descr<?php echo $resource->ResourceId?>"><?php echo $resourceDescription ?></div>
					</div>
				</div>
				...
				<div class="bfi-row" >
					...
					<div class="bfi-col-sm-4 bfi-text-right">
						<a href="<?php echo $resourceRoute ?>" onclick="event.stopPropagation();"  class="bfi-btn" <?php echo COM_BOOKINGFORCONNECTOR_TARGETURL ?>><?php echo _e('Details' , 'bfi')?></a>
					</div>
				</div>
...
<?php if($showdata){ ?>
				...
				bookingfor.shortenText(jQuery("#descr"+val.Resource.ResourceId),150);
