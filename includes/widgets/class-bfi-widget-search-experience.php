...
if ( ! class_exists( 'BFI_Widget_Booking_Search_Experience' ) ) {
	...
	class BFI_Widget_Booking_Search_Experience extends WP_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = __( 'A Search box for Experience.', 'bfi' );
			$this->widget_id          = 'bookingfor_booking_search_experience';
			$this->widget_name        = __( 'BookingFor Search Experience', 'bfi' );
	...
	<?php if($resultinsamepg==1) { ?>[bookingfor_search_result_experience]
	<?php } ?>
