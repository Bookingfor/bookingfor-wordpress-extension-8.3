...
if ( ! class_exists( 'BFI_Widget_Booking_Search_Resources' ) ) {
	...
	class BFI_Widget_Booking_Search_Resources extends WP_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = __( 'A Search box .', 'bfi' );
...
<?php 
	...
	?>
		...
		<?php if($resultinsamepg==1) { ?>[bookingfor_search_result]<?php } ?>
...
//			  $instance['showSenior'] = ! empty( $new_instance[ 'showSenior' ] ) ? 1 : 0;
			...
			//		} elseif ( function_exists( 'icl_register_string' ) ) {
				...
				icl_unregister_string ( $instanceContext, 'btntext');
				icl_register_string( $instanceContext, 'btntext', $instance['btntext'] );
					}
			}
			 return $instance;
		}
