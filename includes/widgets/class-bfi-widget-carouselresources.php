...
if ( ! class_exists( 'BFI_Widget_CarouselResources' ) ) :
class BFI_Widget_CarouselResources extends WP_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'bfi-widget_carouselresources';
		$this->widget_description = __( 'A Carousel list of Resources.', 'bfi' );
		$this->widget_id          = 'bookingfor_carouselresources';
		$this->widget_name        = __( 'BookingFor Carousel Resources', 'bfi' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
...
function form($instance) {
	...
	$tagsList = BFCHelper::getTags($language,bfi_TagsScope::Resource);
	if (!empty($tagsList)) {
		//sort by name
	...
	public function widget( $args, $instance ) {
		...
		bfi_get_template("widgets/carouselresources.php",$args);	
	}
