...
//		add_filter( 'comments_template', array( __CLASS__, 'comments_template_loader' ) );
	...
	public static function template_loader( $template ) {
		...
		if ( is_page( bfi_get_template_page_id( 'searchmapsells' ) )) {
			$file 	= 'search-mapsells.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		if ( is_page( bfi_get_template_page_id( 'searchevents' ) )) {
			$file 	= 'search-events.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		...
		if ( is_page( bfi_get_template_page_id( 'eventdetails' ) )) {
			$file 	= 'eventdetails.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		if ( is_page( bfi_get_template_page_id( 'pointsofinterestdetails' ) )) {
			$file 	= 'pointsofinterestdetails.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		...
		if ( is_page( bfi_get_template_page_id( 'resourcegroupdetails' ) )) {
			$file 	= 'resourcegroupdetails.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		...
		if ( is_page( bfi_get_template_page_id( 'experiencedetails' ) )) {
			$file 	= 'experiencedetails.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		...
		if ( is_page( bfi_get_template_page_id( 'genericrequest' ) )) {
			$file 	= 'genericrequest.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
