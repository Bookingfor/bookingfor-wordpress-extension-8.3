...
class BookingForConnectorModelOnSellUnits
{
	...
	public function __construct($config = array())
	{
		...
		$this->urlResources = '/SearchOnsellSimple'; // '/ResourceonsellView';
		$this->urlResourcesCount = '/GetSearchOnsellCountSimple'; // '/ResourceonsellView';
		$this->resourcesCount = 0;
		$this->urlGetResourcesByIds = '/GetResourceonsellsByIdsSimple';
		$this->urlResourceonsells = '/SearchOnsellSimple'; // '/ResourceonsellView';
...
//			$options['data']['$filter'] = $filter;
		if (isset($masterTypologyId) && $masterTypologyId > 0) {
			$options['data']['masterTypeId'] = $masterTypologyId;
		}
...
//		$options['data']['$orderby'] = 'AddedOn desc';
		...
		if (isset($this->ordering)) {
			$options['data']['orderType'] =  BFCHelper::getQuotedString($this->ordering . ' ' . strtolower($this->direction));
		}
...
//						'$filter' => 'Enabled eq true and TypeId eq ' . $this->TypeId 
		...
		if (isset($r)) {
			$res = json_decode($r);
			$count = 0;
			if (isset($res->d->GetSearchOnsellCountSimple)){
