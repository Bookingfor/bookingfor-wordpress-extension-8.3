...
function bfi_setSessionFromSubmittedDataforEvent() {
	...
	$currParamInSession = BFCHelper::getSearchParamsSessionforEvent();
	$currParam = array(
		...
		'calculateperson' => isset($_REQUEST['calculateperson']) ? $_REQUEST['calculateperson'] : '0',
		...
		'zoneIds' => isset($_REQUEST['zoneIds']) ? $_REQUEST['zoneIds'] : '',
		'merchantIds' => isset($_REQUEST['merchantIds']) ? $_REQUEST['merchantIds'] : '',
		'groupresourceIds' => isset($_REQUEST['groupresourceIds']) ? $_REQUEST['groupresourceIds'] : '',
		...
		'groupTagsIds' => isset($_REQUEST['groupTagsIds']) ? $_REQUEST['groupTagsIds'] : '',
		...
		'minqt' =>  isset($_REQUEST['minqt']) ? $_REQUEST['minqt'] : 1,
		'maxqt' =>  isset($_REQUEST['maxqt']) ? $_REQUEST['maxqt'] : 1,
		...
		'resourcegroupsResults' => isset($_REQUEST['resourcegroupsResults']) ? $_REQUEST['resourcegroupsResults'] : '',
		...
		'filter_order_Dir' => isset($_REQUEST['filter_order_Dir']) ? $_REQUEST['filter_order_Dir'] : '',
		'getBaseFiltersFor' => isset($_REQUEST['getBaseFiltersFor']) ? $_REQUEST['getBaseFiltersFor'] : '',
	);
	BFCHelper::setSearchParamsSessionforEvent($currParam);
}

function bfi_setSessionFromSubmittedDataEvent() {
	$ci = BFCHelper::getStayParam('checkin', new DateTime('UTC'));
//	$ciout = BFCHelper::getStayParam('checkout', new DateTime('UTC'));
	$cultureCode = isset($_REQUEST['cultureCode']) ? $_REQUEST['cultureCode'] : '';
//	$currParamInSession = BFCHelper::getSearchEventParamsSession();
	$currParam = array(
		'checkin' => BFCHelper::getStayParam('checkin', new DateTime('UTC')),
		'checkout' => BFCHelper::getStayParam('checkout', $ci->modify('+1 year')),
		...
		'cityIds' => isset($_REQUEST['cityIds']) ? $_REQUEST['cityIds'] : '',
		'zoneIds' => isset($_REQUEST['zoneIds']) ? $_REQUEST['zoneIds'] : '',
		'getFilters' => isset($_REQUEST['getFilters']) ? $_REQUEST['getFilters'] : 1,
		'categoryIds' => isset($_REQUEST['category']) ? $_REQUEST['category'] : '',
		'newsearch' => isset($_REQUEST['newsearch']) ? $_REQUEST['newsearch'] : '0',
		'searchterm' =>  isset($_REQUEST['searchterm']) ? $_REQUEST['searchterm'] : "",
		'searchTermValue' => isset($_REQUEST['searchTermValue']) ? $_REQUEST['searchTermValue'] : '0',
		'filters' => isset($_REQUEST['filters']) ? $_REQUEST['filters'] : '',
	);

	BFCHelper::setSearchEventParamsSession($currParam);
}
function bfi_setSessionFromSubmittedDataPoi() {
	$cultureCode = isset($_REQUEST['cultureCode']) ? $_REQUEST['cultureCode'] : '';
//	$currParamInSession = BFCHelper::getSearchEventParamsSession();
	$currParam = array(
		'poiName' =>  isset($_REQUEST['poiName']) ? $_REQUEST['poiName'] : "",
		'cultureCode' => $cultureCode,
		'points' => BFCHelper::getVar('points'),
		'tagids' => isset($_REQUEST['tagids']) ? $_REQUEST['tagids'] : '',
		'searchid' => isset($_REQUEST['searchid']) ? $_REQUEST['searchid'] : uniqid('', true),
...
function bfi_setSessionFromSubmittedData($sessionkey = 'search.params') {
	$ci = BFCHelper::getStayParam('checkin', new DateTime('UTC'));
	$merchantCategoryId = isset($_REQUEST['merchantCategoryId']) ? $_REQUEST['merchantCategoryId'] : array();
	$cultureCode = isset($_REQUEST['cultureCode']) ? $_REQUEST['cultureCode'] : '';
	$availabilitytype =  isset($_REQUEST['availabilitytype']) ? $_REQUEST['availabilitytype'] : 1;
	...
	$currParamInSession = BFCHelper::getSearchParamsSession($sessionkey);
	$currParam = array(
		'searchid' => isset($_REQUEST['searchid']) ? $_REQUEST['searchid'] : uniqid('', true),
		'searchtypetab' => isset($_REQUEST['searchtypetab']) ? $_REQUEST['searchtypetab'] : '',
		'newsearch' => isset($_REQUEST['newsearch']) ? $_REQUEST['newsearch'] : '0',
//		'checkin' => BFCHelper::getStayParam('checkin', new DateTime('UTC')),
//		'checkout' => BFCHelper::getStayParam('checkout', $ci->modify(BFCHelper::$defaultDaysSpan)),
		'checkin' => BFCHelper::getStayParam('checkin', null, false),
		'checkout' => BFCHelper::getStayParam('checkout',null, false),
		'duration' => $duration,
		'checkAvailability' => isset($_REQUEST['checkAvailability']) ? $_REQUEST['checkAvailability'] : '0',
		'checkStays' => isset($_REQUEST['checkStays']) ? $_REQUEST['checkStays'] : '0',
		'checkFullPeriod' => isset($_REQUEST['checkFullPeriod']) ? $_REQUEST['checkFullPeriod'] : 0,
		'searchterm' => !empty($_REQUEST['searchtermoverride']) ? $_REQUEST['searchtermoverride'] : (isset($_REQUEST['searchterm']) ? $_REQUEST['searchterm'] : ''),
		'searchTermValue' => isset($_REQUEST['searchTermValue']) ? $_REQUEST['searchTermValue'] : '',
		'dropoff' => isset($_REQUEST['dropoff']) ? $_REQUEST['dropoff'] : '',
		'dropoffValue' => isset($_REQUEST['dropoffValue']) ? $_REQUEST['dropoffValue'] : '',
		'stateIds' => isset($_REQUEST['stateIds']) ? $_REQUEST['stateIds'] : '',
		'regionIds' => isset($_REQUEST['regionIds']) ? $_REQUEST['regionIds'] : '',
		'cityIds' => isset($_REQUEST['cityIds']) ? $_REQUEST['cityIds'] : '',
		'zoneIds' => isset($_REQUEST['zoneIds']) ? $_REQUEST['zoneIds'] : '',
		...
		'filter_order_Dir' => isset($_REQUEST['filter_order_Dir']) ? $_REQUEST['filter_order_Dir'] : '',
		'getBaseFiltersFor' => isset($_REQUEST['getBaseFiltersFor']) ? $_REQUEST['getBaseFiltersFor'] : '',
		'dateselected' => isset($_REQUEST['dateselected']) ? $_REQUEST['dateselected'] : 0,
	);
	BFCHelper::setSearchParamsSession($currParam,$sessionkey);	
}
