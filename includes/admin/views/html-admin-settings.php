	...
	<form method="post" action="options.php" class="">
		...
		<div id="bfiadminsetting">
			<ul class="bfi-tabs">
				...
				<li><a href="#bfitab1" data-toggle="tab" aria-expanded="false" >Maps</a></li>
				<li><a href="#bfitab8" data-toggle="tab" aria-expanded="false" >Pagina Risultati Ricerca</a></li>
				<li><a href="#bfitab2" data-toggle="tab" aria-expanded="false" >Google recaptcha</a></li>
				<li><a href="#bfitab3" data-toggle="tab" aria-expanded="false" >Person</a></li>
				<li><a href="#bfitab6" data-toggle="tab" aria-expanded="false" >Analyitics</a></li>
				<li style="display:<?php echo (!empty( COM_BOOKINGFORCONNECTOR_SHOWADVANCESETTING))?"":"none;"; ?>" ><a href="#bfitab4" data-toggle="tab" aria-expanded="false" >Security</a></li>
			...
			<div id="bfitab1">
				<?php do_settings_sections("bfi-options-maps"); ?>      
			</div>
			<div id="bfitab2">
				<?php do_settings_sections("bfi-options-recaptcha"); ?>      
			</div>
			<div id="bfitab3">
				<?php do_settings_sections("bfi-options-person"); ?>   
			</div>
			<div id="bfitab6">
				<?php do_settings_sections("bfi-options-analyitics"); ?>  
			</div>
			<div id="bfitab4">
				<?php do_settings_sections("bfi-options-security"); ?>  
			</div>
			<div id="bfitab5">
