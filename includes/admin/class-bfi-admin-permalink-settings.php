...
//		add_settings_field(
//			'bookingfor_eventlist_slug',                 // id
//			__( 'BookingFor Event List page', 'bfi' ),        // setting title
//			array( $this, 'eventlist_slug_input' ),       // display callback
//			'permalink',                                    // settings page
//			'optional'                                      // settings section
//		);
		add_settings_field(
		...
		add_settings_field(
			'bookingfor_genericrequest_slug',                 // id
			__( 'BookingFor Generic Request page', 'bfi' ),        // setting title
			array( $this, 'genericrequest_slug_input' ),       // display callback
			'permalink',                                    // settings page
			'optional'                                      // settings section
		);
		add_settings_field(
			'bookingfor_eventdetails_slug',                 // id
			__( 'BookingFor Event Details page', 'bfi' ),        // setting title
			array( $this, 'eventdetails_slug_input' ),       // display callback
			'permalink',                                    // settings page
			'optional'                                      // settings section
		);
		add_settings_field(
			'bookingfor_pointsofinterestdetails_slug',                 // id
			__( 'BookingFor PointsOfInterest Details page', 'bfi' ),        // setting title
			array( $this, 'pointsofinterestdetails_slug_input' ),       // display callback
			'permalink',                                    // settings page
			'optional'                                      // settings section
		);
	 ...
	 * Show a slug input box.
	 */
	public function search_events_slug_input() {
		$permalinks = get_option( 'bookingfor_permalinks' );
		?>
		<input name="bookingfor_search_events_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['search_events_base'] ) ) echo esc_attr( $permalinks['search_events_base'] ); ?>" placeholder="<?php echo esc_attr_x('search-events', 'slug', 'bfi') ?>" />
		<?php
	}
	 ...
	 * Show a slug input box.
	 */
	public function eventlist_slug_input() {
		$permalinks = get_option( 'bookingfor_permalinks' );
		?>
		<input name="bookingfor_eventlist_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['eventlist_base'] ) ) echo esc_attr( $permalinks['eventlist_base'] ); ?>" placeholder="<?php echo esc_attr_x('eventlist', 'slug', 'bfi') ?>" />
		<?php
	}
	 ...
	 * Show a slug input box.
	 */
	public function genericrequest_slug_input() {
		$permalinks = get_option( 'bookingfor_permalinks' );
		?>
		<input name="bookingfor_genericrequest_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['genericrequest_base'] ) ) echo esc_attr( $permalinks['genericrequest_base'] ); ?>" placeholder="<?php echo esc_attr_x('genericrequest', 'slug', 'bfi') ?>" />
		<?php
	}
	 ...
	 * Show a slug input box.
	 */
	public function eventdetails_slug_input() {
		$permalinks = get_option( 'bookingfor_permalinks' );
		?>
		<input name="bookingfor_event_details_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['event_details_base'] ) ) echo esc_attr( $permalinks['event_details_base'] ); ?>"  placeholder="<?php echo esc_attr_x('eventdetails', 'slug', 'bfi') ?>"/> 
		<?php
	}

	public function pointsofinterestdetails_slug_input() {
		$permalinks = get_option( 'bookingfor_permalinks' );
		?>
		<input name="bookingfor_pointsofinterest_details_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['pointsofinterest_details_base'] ) ) echo esc_attr( $permalinks['pointsofinterest_details_base'] ); ?>"  placeholder="<?php echo esc_attr_x('pointsofinterestdetails', 'slug', 'bfi') ?>"/> 
		<?php
	}
...
//			$permalinks['eventlist_base']   = bfi_sanitize_permalink( trim( $_POST['bookingfor_eventlist_slug'] ) );
			$permalinks['cartdetails_base']   = bfi_sanitize_permalink( trim( $_POST['bookingfor_cartdetails_slug'] ) );
			$permalinks['genericrequest_base']   = bfi_sanitize_permalink( trim( $_POST['bookingfor_genericrequest_slug'] ) );
			$permalinks['onsell_details_base']   = bfi_sanitize_permalink( trim( $_POST['bookingfor_onsell_details_slug'] ) );
			$permalinks['event_details_base']   = bfi_sanitize_permalink( trim( $_POST['bookingfor_event_details_slug'] ) );
			$permalinks['pointsofinterest_details_base']   = bfi_sanitize_permalink( trim( $_POST['bookingfor_pointsofinterest_details_slug'] ) );
