...
//		add_settings_field("bfi_showbadge_key", "Show badge number items on cart", array( $this, 'display_bfi_showbadge_key_element'), "bfi-options", "section");
		...
		add_settings_section("sectionanalyitics", "Analyitics Settings", null, "bfi-options-analyitics");
		add_settings_field("bfi_gaenabled_key", "Enabled",  array( $this, 'display_bfi_gaenabled_key_element'), "bfi-options-analyitics", "sectionanalyitics");
