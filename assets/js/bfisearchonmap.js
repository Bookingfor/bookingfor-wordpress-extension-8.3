		...
		function handleApiReadyMapDrawer() {
			bfiMyLatlngMapDrawer = new google.maps.LatLng(bfi_variables.bfi_mapx,bfi_variables.bfi_mapy );
			var myOptions = {
	...
	function deleteSelectedShape() {
		...
		function bfiOpenGoogleMapDrawer(bfiCurrFormId, bfiCurrModID) {
			...
			if (typeof google === "undefined" || typeof google !== 'object' || typeof google.maps !== 'object'){
				...
				script.src = bfi_variables.bfi_googlemapsscript + "&callback=handleApiReadyMapDrawer";
